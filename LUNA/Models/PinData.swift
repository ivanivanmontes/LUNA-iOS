...
let dummyPins: [PinData] = [
    PinData(id: 1, title: "Sunset at the Beach", description: "A beautiful sunset over the ocean.", mediaUrls: ["https://example.com/photo1.jpg"], coordinate: Coordinate(latitude: 34.0113, longitude: -118.4921), creationDate: Date(), userID: 100),
